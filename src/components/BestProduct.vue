<template>
  <v-row class="mb-3 row">
    <v-col cols="8">
      <v-card class="h-lg-100 overflow-hidden card pb-0" hover color="#f9fafd">
        <div class="p-0 card-body">
          <div class="table-responsive">
            <div class="mb-0 fs--1 table table-borderless">
              <v-content class="bg-light">
                <v-row class="text-900">
                  <v-col>Best Selling Products</v-col>
                  <v-col class="text-end">Revenue ( $3189)</v-col>
      ...
      <div class="h-lg-100 card">
        <div class="py-2 bg-light card-header">
          <div class="align-items-center row">
            <div class="col"><h6 class="mb-0">Shared Files</h6></div>
        ...
        <div class="pb-0 card-body">
          <div class="d-flex align-items-center mb-3 hover-actions-trigger">
            <div class="file-thumbnail">
              <img
                ...
                src="/static/media/5.09ac6a83.jpg"
                alt=""
              />
            </div>
            <div class="ms-3 flex-shrink-1 flex-grow-1">
              ...
              <div class="hover-actions end-0 top-50 translate-middle-y">
                <a
                  ...
                  ><img
                    src="/static/media/cloud-download.2dc713ed.svg"
                    alt="Download"
                    width="15" /></a
                ><button
                  type="button"
                ...
                >
                  <img
                    src="/static/media/edit-alt.e9942aac.svg"
                    alt="Edit"
                    width="15"
                  />
                </button>
          ...
          <div class="d-flex align-items-center mb-3 hover-actions-trigger">
            <div class="file-thumbnail">
              <img
                class="h-100 w-100 fit-cover rounded-2 border"
                src="/static/media/3.ba98a1ec.jpg"
                alt=""
              />
            </div>
            <div class="ms-3 flex-shrink-1 flex-grow-1">
              ...
              <div class="hover-actions end-0 top-50 translate-middle-y">
                <a
                  role="button"
                  tabindex="0"
                  href="/static/media/3.ba98a1ec.jpg"
                  download=""
                  class="border-300 me-1 text-600 btn btn-light btn-sm"
                  ><img
                    src="/static/media/cloud-download.2dc713ed.svg"
          ...
          <div class="d-flex align-items-center mb-3 hover-actions-trigger">
            <div class="file-thumbnail">
              <img
                class="h-100 w-100 fit-cover rounded-2"
          ...
          <div class="d-flex align-items-center mb-3 hover-actions-trigger">
            <div class="file-thumbnail">
              <img
                class="h-100 w-100 fit-cover rounded-2 border"
                src="/static/media/2.2001c1c3.jpg"
                alt=""
              />
            </div>
            <div class="ms-3 flex-shrink-1 flex-grow-1">
              ...
              <div class="hover-actions end-0 top-50 translate-middle-y">
                <a
                  role="button"
                  tabindex="0"
                  href="/static/media/2.2001c1c3.jpg"
                  download=""
                  class="border-300 me-1 text-600 btn btn-light btn-sm"
                  ><img
                    src="/static/media/cloud-download.2dc713ed.svg"
